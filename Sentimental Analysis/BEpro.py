...
def main():
    ...
    #     global acc1
    #     def __init__( self, parent ):
    #         wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = wx.EmptyString, pos = wx.DefaultPosition, size = wx.Size( 862,415 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
    ...
    #         bSizer3.Add( self.m_richText2, 1, wx.EXPAND |wx.ALL, 5 )
    ...
    #         # Connect Events
    #         self.Bind( wx.EVT_ACTIVATE, self.active )
    ...
    #             for i in tokenized: 
    #                 #print(i)
    #                 self.m_richText2.WriteText(str(i))
    ...
    #                 #print(tagged)
    #                 self.m_richText2.Newline()                         
    #                 self.m_richText2.WriteText(str(tagged))
    #                 self.m_richText2.Newline()  
    ...
    #         ps = PorterStemmer()
    #         for j in data["text"]:
    #             self.m_richText2.WriteText(str(j))
    #             self.m_richText2.Newline()  
    #             #print(j)
    #             words = word_tokenize(j)
    #             for w in words:
    #                 #print(ps.stem(w))
    #                 self.m_richText2.WriteText(str(ps.stem(w)))
    #                 self.m_richText2.Newline()  
